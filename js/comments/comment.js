async function comments(){
    let commentsTitData = await fetch("https://alihadavandi13.github.io/db.json/db.json");
    ...
    let commentsData = await fetch("https://alihadavandi13.github.io/db.json/db.json");
