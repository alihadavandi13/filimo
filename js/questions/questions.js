async function questions(){
    ...
    let questionsTitleData = await fetch("https://alihadavandi13.github.io/db.json/db.json");
    ...
    let questionsBoxData = await fetch("https://alihadavandi13.github.io/db.json/db.json");
