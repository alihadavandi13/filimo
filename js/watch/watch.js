async function watch(){
    let watchData = await fetch("https://alihadavandi13.github.io/db.json/db.json");
    ...
    let devicesData = await fetch("https://alihadavandi13.github.io/db.json/db.json");
    ...
    let devicesBtnData = await fetch("https://alihadavandi13.github.io/db.json/db.json");
