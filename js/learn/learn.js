async function learn(){
    let learnData = await fetch("https://alihadavandi13.github.io/db.json/db.json");
    ...
    let learnDevicesData = await fetch("https://alihadavandi13.github.io/db.json/db.json");
